          ...
          <CardContent className="space-y-6">
            <div>
              <div className="flex justify-between items-center mb-2">
                ...
                <span className="text-text dark:text-text-dark font-bold">
                  {userData.competitionEntries}/{userData.maxEntries}
                </span>
              </div>
              <Progress
                value={
                  (userData.competitionEntries / userData.maxEntries) * 100
                }
                className="h-3 bg-primary/10 dark:bg-primary-dark/10"
              />
              <p className="text-xs text-text/60 dark:text-text-dark/60 mt-2">
                {userData.maxEntries - userData.competitionEntries} entries
                remaining
              </p>
            </div>
            ...
            <div>
              <div className="flex justify-between items-center mb-2">
                ...
                <span className="text-text dark:text-text-dark font-bold">
                  {userData.projectsCompleted}/{userData.maxProjects}
                </span>
              </div>
              <Progress
                value={
                  (userData.projectsCompleted / userData.maxProjects) * 100
                }
                className="h-3 bg-secondary/10 dark:bg-secondary-dark/10"
              />
              <p className="text-xs text-text/60 dark:text-text-dark/60 mt-2">
                {userData.maxProjects - userData.projectsCompleted} projects
                available
              </p>
            </div>
          </CardContent>
        ...
        <Card className="bg-bg dark:bg-bg-dark border-primary/10 dark:border-primary-dark/10 shadow-lg">
          ...
          <CardContent>
            <div className="space-y-4">
              <div className="flex items-center justify-between p-4 bg-gradient-to-r from-accent/10 to-primary/10 dark:from-accent-dark/10 dark:to-primary-dark/10 rounded-lg">
                <div className="flex items-center space-x-3">
                  <div className="p-2 bg-accent/20 dark:bg-accent-dark/20 rounded-lg">
                    <Star className="h-5 w-5 text-accent dark:text-accent-dark" />
                  </div>
                  <div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="text-center p-3 bg-primary/5 dark:bg-primary-dark/5 rounded-lg border border-primary/10 dark:border-primary-dark/10">
                  <CheckCircle className="h-6 w-6 text-primary dark:text-primary-dark mx-auto mb-1" />
                ...
                <div className="text-center p-3 bg-secondary/5 dark:bg-secondary-dark/5 rounded-lg border border-secondary/10 dark:border-secondary-dark/10">
                  <Users className="h-6 w-6 text-secondary dark:text-secondary-dark mx-auto mb-1" />
                  <div className="text-sm font-medium text-text dark:text-text-dark">
                    Team Player
                  </div>
                </div>
        ...
        <CardContent>
          <div className="space-y-4">
            {[
              ...
              <div
                key={index}
                className="flex items-center space-x-4 p-3 rounded-lg hover:bg-primary/5 dark:hover:bg-primary-dark/5 transition-colors"
              >
                ...
                <ArrowRight className="h-4 w-4 text-text/30 dark:text-text-dark/30" />
              </div>
            ))}
          </div>
        </CardContent>
