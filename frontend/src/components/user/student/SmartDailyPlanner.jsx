  ...
  return (
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-primary/20 via-primary/10 to-secondary/20 dark:from-primary-dark/20 dark:via-primary-dark/10 dark:to-secondary-dark/20 p-8 border border-primary/20 dark:border-primary-dark/20">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-3">
            ...
            <Badge className="bg-accent/30 dark:bg-accent-dark/30 text-accent dark:text-accent-dark px-4 py-2 text-sm font-medium border border-accent/40 dark:border-accent-dark/40">
      ...
      <div className="grid gap-6 md:grid-cols-3">
        ...
        <Card className="md:col-span-2 bg-gradient-to-br from-accent/5 via-transparent to-primary/5 dark:from-accent-dark/5 dark:to-primary-dark/5 border-accent/20 dark:border-accent-dark/20">
          <CardContent className="p-8 text-center">
            <div className="mb-6">
              <div className="p-4 bg-accent/20 dark:bg-accent-dark/20 rounded-full mx-auto w-20 h-20 flex items-center justify-center mb-4">
      ...
      {dailyPlan && (
        <div className="space-y-6">
          {/* Plan Overview */}
          <Card className="bg-gradient-to-br from-primary/10 via-transparent to-accent/10 dark:from-primary-dark/10 dark:to-accent-dark/10 border-primary/20 dark:border-primary-dark/20 shadow-lg">
            <CardHeader>
              <div className="flex items-center justify-between">
                ...
                <Button
                  ...
                  variant="outline"
                  size="sm"
                  className="border-primary/30 dark:border-primary-dark/30 text-primary dark:text-primary-dark hover:bg-primary/10 dark:hover:bg-primary-dark/10"
                >
            ...
            <CardContent className="space-y-4">
              <div className="p-4 bg-bg/50 dark:bg-bg-dark/50 rounded-lg border border-primary/20 dark:border-primary-dark/20">
                ...
                {dailyPlan.schedule.map((item, index) => (
                  ...
                  >
                    <div className="flex items-center justify-between mb-3">
                      <div className="flex items-center space-x-3">
                        <div className="p-2 bg-bg/30 dark:bg-bg-dark/30 rounded-lg">
                      ...
                      <div className="flex items-center space-x-2">
                        {item.subject && (
                          <Badge className="bg-primary/20 dark:bg-primary-dark/20 text-primary dark:text-primary-dark">
                            {item.subject}
                          </Badge>
                        )}
                        {item.priority && (
                    ...
                    {item.tips && (
                      <div className="bg-bg/50 dark:bg-bg-dark/50 rounded-lg p-3 border border-primary/10 dark:border-primary-dark/10">
              ...
              <CardContent>
                <div className="space-y-3">
                  {dailyPlan.dailyGoals.map((goal, index) => (
                    <div
                      key={index}
                      className="flex items-center space-x-3 p-3 bg-primary/5 dark:bg-primary-dark/5 rounded-lg hover:bg-primary/10 dark:hover:bg-primary-dark/10 transition-colors cursor-pointer"
                    >
                      <div className="w-4 h-4 border-2 border-primary dark:border-primary-dark rounded"></div>
              ...
              <CardContent>
                <div className="space-y-3">
                  {dailyPlan.studyTips.map((tip, index) => (
                    <div
                      key={index}
                      className="p-3 bg-accent/5 dark:bg-accent-dark/5 rounded-lg border border-accent/20 dark:border-accent-dark/20"
                    >
            ...
            <CardContent>
              <div className="space-y-4">
                <div>
                  ...
                  <Progress
                    value={0}
                    className="h-3 bg-primary/10 dark:bg-primary-dark/10"
                  />
      ...
      {!dailyPlan && !isGenerating && (
        <Card className="bg-gradient-to-br from-primary/5 via-transparent to-accent/5 dark:from-primary-dark/5 dark:to-accent-dark/5 border-primary/20 dark:border-primary-dark/20 shadow-lg">
          <CardContent className="p-12 text-center">
            <div className="p-6 bg-primary/10 dark:bg-primary-dark/10 rounded-full mx-auto w-24 h-24 flex items-center justify-center mb-6">
